# Incident Insights — machine-3-10

Generated 2026-09-24 04:57:34 from 23,692 real telemetry readings (threshold 0.52).

**2 incidents triggered** across **1 distinct fault types**, in **1 separate burst(s)**.
...
|---|---|---|
| Network Interface Issues | High | 2 |
...
- Check network hardware _(recommended 2x)_
- Inspect cable connections _(recommended 2x)_
- Review network driver logs _(recommended 2x)_
- Monitor packet loss rate _(recommended 2x)_
